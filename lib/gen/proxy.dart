...
class ProxyServer extends ChromeObject {
  static ProxyServer create(JsObject proxy) => proxy == null ? null : new ProxyServer(proxy);
...
class ProxyRules extends ChromeObject {
  static ProxyRules create(JsObject proxy) => proxy == null ? null : new ProxyRules(proxy);
...
class PacScript extends ChromeObject {
  static PacScript create(JsObject proxy) => proxy == null ? null : new PacScript(proxy);
...
class ProxyConfig extends ChromeObject {
  static ProxyConfig create(JsObject proxy) => proxy == null ? null : new ProxyConfig(proxy);
