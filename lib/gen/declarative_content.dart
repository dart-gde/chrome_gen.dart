 ...
 */
library chrome.declarative_content;

import '../src/common.dart';

/// Accessor for the `chrome.declarative_content` namespace.
final ChromeDeclarativeContent declarative_content = new ChromeDeclarativeContent._();
